...
class UsersList extends Component {
    ...
    render() {
        ...
        return (
            <Col className={detail ? "user-container" : "user-container-clickable"}>
                <Row>
                    ...
                    <div>
                        <span><i className="fa fa-envelope-o"
                                 aria-hidden="true"></i> {UsersText.email}: {user.email}
                                 </span>
                    </div>

                    <div>
                        <span>
                            <i className="fa fa-phone" aria-hidden="true"></i> {UsersText.tel}: {user.cell}
                        </span>
                    </div>
