        ...
        return (
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <div>
                        <span><i className="fa fa-envelope-o"
                                 aria-hidden="true"></i> {UsersText.email}: {details.email}
                                 </span>
                    </div>

                    <div>
                        <span>
                            <i className="fa fa-phone" aria-hidden="true"></i> {UsersText.tel}: {details.cell}
                        </span>
                    </div>
                    ...
                    <div>
                        <span>{UsersText.street}: {details.location.street}</span>
                    </div>

                    <div>
                        <span>{UsersText.city}: {details.location.city}</span>
                    </div>

                    <div>
                        <span>{UsersText.postcode}: {details.location.postcode}</span>
                    </div>
                </Modal.Body>
            </Modal>
        )
