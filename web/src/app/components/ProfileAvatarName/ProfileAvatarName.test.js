...
describe('ProfileAvatarName', () => {
  ...
  test('Component should render component ProfileAvatar', () => {
    ...
    expect(component.find('ProfileAvatar').html()).toEqual(
      '<div class="inline"><div class="profile-avatar-large" style="background-image:url(thumbnail.png)"></div></div>'
    )
