...
import {getUsersList, DEFAULT_START_PAGE, DEFAULT_PAGE_SIZE} from "../actions/users"
    ...
    callUsersList() {
        ...
        switch (route.open) {
            ...
            case OPEN_FEMALE_USERS:
                dispatch(getUsersList(DEFAULT_START_PAGE, DEFAULT_PAGE_SIZE, FILTER_USERS.gender.female))
                break;
            case OPEN_MALE_USERS:
                dispatch(getUsersList(DEFAULT_START_PAGE, DEFAULT_PAGE_SIZE, FILTER_USERS.gender.male))
                break;
            case OPEN_ALL_USERS:
            default:
                dispatch(getUsersList(DEFAULT_START_PAGE, DEFAULT_PAGE_SIZE, FILTER_USERS.default))
                break;
        }
